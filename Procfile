...
consumer: unset DISABLE_DATADOG_AGENT && /app/.profile.d/datadog.sh; DATADOG_TRACE_ENABLED="true" bin/start-pgbouncer-stunnel ddtrace-run python manage.py runworker
