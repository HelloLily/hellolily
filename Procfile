...
worker2: bin/start-pgbouncer-stunnel celery worker --loglevel=info --app=lily.celery -Q email_scheduled_tasks,email_first_sync -n worker2.%h -c12 -P eventlet --without-gossip --without-mingle --without-heartbeat
