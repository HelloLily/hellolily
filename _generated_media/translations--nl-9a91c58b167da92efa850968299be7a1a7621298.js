...
catalog['%(sel)s of %(cnt)s selected'][0] = '%(sel)s van de %(cnt)s geselecteerd';
catalog['%(sel)s of %(cnt)s selected'][1] = '%(sel)s van de %(cnt)s geselecteerd';
catalog['6 a.m.'] = 'Zes uur \'s ochtends';
catalog['Add & edit'] = 'Toevoegen en bewerken';
catalog['Add'] = 'Toevoegen';
catalog['Available %s'] = 'Beschikbare %s';
catalog['Calendar'] = 'Kalender';
catalog['Cancel'] = 'Annuleren';
catalog['Choose a time'] = 'Kies een tijd';
catalog['Choose all'] = 'Kies alle';
catalog['Choose'] = 'Kiezen';
catalog['Chosen %s'] = 'Gekozen %s';
catalog['Click to choose all %s at once.'] = 'Klik om alle %s kiezen in een keer.';
catalog['Click to remove all chosen %s at once.'] = 'Klik om alle gekozen %s tegelijk te verwijderen.';
catalog['Clock'] = 'Klok';
...
catalog['New account'] = 'Nieuw bedrijf';
catalog['Noon'] = 'Twaalf uur \'s middags';
catalog['Now'] = 'Nu';
...
catalog['Type into this box to filter down the list of available %s.'] = 'Type in dit vak om te filteren in de lijst met beschikbare %s.';
catalog['Yesterday'] = 'Gisteren';
catalog['You have selected an action, and you haven\'t made any changes on individual fields. You\'re probably looking for the Go button rather than the Save button.'] = 'U heeft een actie geselecteerd en heeft geen wijzigingen gemaakt op de individuele velden. U zoekt waarschijnlijk naar de Gaan knop in plaats van de Opslaan knop.';
...
catalog['You have unsaved changes on individual editable fields. If you run an action, your unsaved changes will be lost.'] = 'U heeft niet opgeslagen wijzigingen op enkele indviduele velden. Als u nu een actie uitvoert zullen uw wijzigingen verloren gaan.';
