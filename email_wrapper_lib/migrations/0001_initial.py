    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('provider_id', models.PositiveSmallIntegerField(choices=[(1, b'google'), (2, b'microsoft')], db_index=True, verbose_name='Provider id')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('subject', models.CharField(blank=True, default=b'', max_length=255, verbose_name='Subject')),
                ('body_text', models.TextField(blank=True, default=b'', verbose_name='Body text')),
                ('body_html', models.TextField(blank=True, default=b'', verbose_name='Body html')),
                ('message_type', models.PositiveSmallIntegerField(choices=[(0, 'New'), (1, 'Reply'), (2, 'Reply all'), (3, 'Forward')], verbose_name='Message type')),
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='drafts', to='email_wrapper_lib.EmailAccount', verbose_name='Account')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(max_length=255, upload_to=email_wrapper_lib.models.models.attachment_upload_path, verbose_name='File')),
                ('cid', models.TextField(default=b'', editable=False)),
                ('draft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='attachments', to='email_wrapper_lib.EmailDraft')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipient_type', models.PositiveSmallIntegerField(choices=[(0, 'To'), (1, 'CC'), (2, 'BCC')], verbose_name='Recipient type')),
                ('draft', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='email_wrapper_lib.EmailDraft', verbose_name='Draft')),
            ],
        ),
        migrations.CreateModel(
            name='EmailFolder',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('account', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='google_sync_info', to='email_wrapper_lib.EmailAccount', verbose_name='Account')),
            ],
        ),
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('history_id', models.CharField(max_length=255, null=True, verbose_name='History token')),
                ('folder', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='microsoft_sync_info', to='email_wrapper_lib.EmailFolder', verbose_name='Folder')),
            ],
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            name='in_reply_to',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='draft_replies', to='email_wrapper_lib.EmailMessage', verbose_name='In reply to'),
        ),
        migrations.AddField(
            model_name='emaildraft',
            name='recipients',
            field=models.ManyToManyField(related_name='drafts', through='email_wrapper_lib.EmailDraftToEmailRecipient', to='email_wrapper_lib.EmailRecipient', verbose_name='Recipients'),
        ),
