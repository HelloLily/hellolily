    ...
    $stateProvider.state('base.accounts.detail', {
        ...
        resolve: {
            ...
            caseList: ['Case', '$stateParams', (Case, $stateParams) => {
                return Case.search({filterquery: 'account.id:' + $stateParams.id, sort: '-expires', size: 150}).$promise;
            }],
            ...
            dealList: ['Deal', '$stateParams', (Deal, $stateParams) => {
                return Deal.search({filterquery: 'account.id:' + $stateParams.id, sort: '-next_step_date', size: 150}).$promise;
            }],
        },
    });
}
