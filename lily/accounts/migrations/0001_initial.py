...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('accounts_account', (
            ...
            ('customer_id', self.gf('django.db.models.fields.CharField')(max_length=32, blank=True)),
            ('name', self.gf('django.db.models.fields.CharField')(max_length=255)),
            ('flatname', self.gf('django.db.models.fields.CharField')(max_length=255, blank=True)),
            ('status', self.gf('django.db.models.fields.CharField')(max_length=50, blank=True)),
            ('company_size', self.gf('django.db.models.fields.CharField')(max_length=15, blank=True)),
            ('logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(blank=True)),
            ('legalentity', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('taxnumber', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('bankaccountnumber', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
            ('cocnumber', self.gf('django.db.models.fields.CharField')(max_length=10, blank=True)),
            ('iban', self.gf('django.db.models.fields.CharField')(max_length=40, blank=True)),
            ('bic', self.gf('django.db.models.fields.CharField')(max_length=20, blank=True)),
        ))
        db.send_create_signal('accounts', ['Account'])

        # Adding M2M table for field phone_numbers on 'Account'
        db.create_table('accounts_account_phone_numbers', (
        ...
        db.create_unique('accounts_account_phone_numbers', ['account_id', 'phonenumber_id'])

        # Adding M2M table for field social_media on 'Account'
        db.create_table('accounts_account_social_media', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False)),
            ('socialmedia', models.ForeignKey(orm['utils.socialmedia'], null=False))
        ))
        db.create_unique('accounts_account_social_media', ['account_id', 'socialmedia_id'])

        # Adding M2M table for field addresses on 'Account'
        db.create_table('accounts_account_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False)),
            ('address', models.ForeignKey(orm['utils.address'], null=False))
        ))
        db.create_unique('accounts_account_addresses', ['account_id', 'address_id'])

        # Adding M2M table for field email_addresses on 'Account'
        db.create_table('accounts_account_email_addresses', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False)),
            ('emailaddress', models.ForeignKey(orm['utils.emailaddress'], null=False))
        ))
        db.create_unique('accounts_account_email_addresses', ['account_id', 'emailaddress_id'])

        # Adding M2M table for field tags on 'Account'
        db.create_table('accounts_account_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('account', models.ForeignKey(orm['accounts.account'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('accounts_account_tags', ['account_id', 'tag_id'])

        # Adding model 'Website'
        db.create_table('accounts_website', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('website', self.gf('django.db.models.fields.URLField')(max_length=255)),
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='websites', to=orm['accounts.Account'])),
            ('is_primary', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('accounts', ['Website'])

    def backwards(self, orm):
        # Deleting model 'Account'
        db.delete_table('accounts_account')

        # Removing M2M table for field phone_numbers on 'Account'
        db.delete_table('accounts_account_phone_numbers')

        # Removing M2M table for field social_media on 'Account'
        db.delete_table('accounts_account_social_media')

        # Removing M2M table for field addresses on 'Account'
        db.delete_table('accounts_account_addresses')

        # Removing M2M table for field email_addresses on 'Account'
        db.delete_table('accounts_account_email_addresses')

        # Removing M2M table for field tags on 'Account'
        db.delete_table('accounts_account_tags')

        # Deleting model 'Website'
        db.delete_table('accounts_website')
    ...
    models = {
        ...
        'accounts.website': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'websites'", 'to': "orm['accounts.Account']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
