...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.legalentity'
        db.add_column('accounts_account', 'legalentity',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Account.taxnumber'
        db.add_column('accounts_account', 'taxnumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Account.bankaccountnumber'
        db.add_column('accounts_account', 'bankaccountnumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

        # Adding field 'Account.cocnumber'
        db.add_column('accounts_account', 'cocnumber',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=10, blank=True),
                      keep_default=False)

        # Adding field 'Account.iban'
        db.add_column('accounts_account', 'iban',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=40, blank=True),
                      keep_default=False)

        # Adding field 'Account.bic'
        db.add_column('accounts_account', 'bic',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=20, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.legalentity'
        db.delete_column('accounts_account', 'legalentity')

        # Deleting field 'Account.taxnumber'
        db.delete_column('accounts_account', 'taxnumber')

        # Deleting field 'Account.bankaccountnumber'
        db.delete_column('accounts_account', 'bankaccountnumber')

        # Deleting field 'Account.cocnumber'
        db.delete_column('accounts_account', 'cocnumber')

        # Deleting field 'Account.iban'
        db.delete_column('accounts_account', 'iban')

        # Deleting field 'Account.bic'
        db.delete_column('accounts_account', 'bic')
