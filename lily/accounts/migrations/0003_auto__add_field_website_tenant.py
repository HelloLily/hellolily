...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Website.tenant'
        db.add_column('accounts_website', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tenant.Tenant'], blank=True, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Website.tenant'
        db.delete_column('accounts_website', 'tenant_id')
