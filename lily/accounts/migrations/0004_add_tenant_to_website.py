...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Set for every website the tenant_id from the account it is linked to."""
        for website in orm['accounts.Website'].objects.iterator():
            website.tenant = website.account.tenant
            website.save()

    def backwards(self, orm):
        """No need to do anything to revert this migration."""
        pass
