...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.tenant'
        db.add_column('accounts_account', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['multitenant.TenantModel']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.tenant'
        db.delete_column('accounts_account', 'tenant_id')
    ...
    models = {
        'accounts.account': {
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multitenant.TenantModel']"})
        },
        'accounts.website': {
