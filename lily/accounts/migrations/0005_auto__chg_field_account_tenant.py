...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Account.tenant'
        db.alter_column('accounts_account', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multitenant.Tenant']))
    def backwards(self, orm):

        # Changing field 'Account.tenant'
        db.alter_column('accounts_account', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multitenant.TenantModel']))
    models = {
        'accounts.account': {
