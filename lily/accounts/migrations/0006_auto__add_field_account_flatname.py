...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Account.flatname'
        db.add_column('accounts_account', 'flatname',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Account.flatname'
        db.delete_column('accounts_account', 'flatname')
    ...
    models = {
        'accounts.account': {
            ...
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['multitenant.Tenant']", 'blank': 'True'})
        },
        'accounts.website': {
