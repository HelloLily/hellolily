...
from lily.accounts.views import add_account_view, edit_account_view, delete_account_view, list_account_view
...
urlpatterns = patterns('',
     ...
     url(r'^details/(?P<pk>[\w-]+)/$', edit_account_view, name='account_details'),
