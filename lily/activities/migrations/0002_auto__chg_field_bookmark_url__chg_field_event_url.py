...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('activities_bookmark', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

        # Changing field 'Event.url'
        db.alter_column('activities_event', 'url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'Bookmark.url'
        db.alter_column('activities_bookmark', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))

        # Changing field 'Event.url'
        db.alter_column('activities_event', 'url', self.gf('django.db.models.fields.URLField')(max_length=200))
