...
from lily.api.mixins import ModelChangesMixin, TimeLogMixin, FileMixin, DataExistsMixin
...
class CaseViewSet(ModelChangesMixin, TimeLogMixin, FileMixin, DataExistsMixin, viewsets.ModelViewSet):
    """
    retrieve:
