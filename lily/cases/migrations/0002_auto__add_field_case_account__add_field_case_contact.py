...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.account'
        db.add_column('cases_case', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['accounts.Account'], null=True, blank=True),
                      keep_default=False)

        # Adding field 'Case.contact'
        db.add_column('cases_case', 'contact',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['contacts.Contact'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.account'
        db.delete_column('cases_case', 'account_id')

        # Deleting field 'Case.contact'
        db.delete_column('cases_case', 'contact_id')
