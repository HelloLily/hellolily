...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.expires'
        db.add_column('cases_case', 'expires',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2014, 1, 14, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.expires'
        db.delete_column('cases_case', 'expires')
    ...
    models = {
        ...
        'cases.case': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 1, 14, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_deleted': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
