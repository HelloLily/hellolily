...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.archived'
        db.add_column('cases_case', 'archived',
    ...
    def backwards(self, orm):
        # Deleting field 'Case.archived'
        db.delete_column('cases_case', 'archived')
    ...
    models = {
        ...
        'cases.case': {
            ...
            'archived': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 3, 25, 0, 0)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
