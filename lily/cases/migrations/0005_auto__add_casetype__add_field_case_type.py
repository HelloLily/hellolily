...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Case.type'
        db.add_column(u'cases_case', 'type',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cases', null=True, to=orm['cases.CaseType']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Case.type'
        db.delete_column(u'cases_case', 'type_id')
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 9, 16, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
