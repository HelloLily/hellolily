...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'CaseStatus'
        db.create_table(u'cases_casestatus', (
        ...
        db.send_create_signal(u'cases', ['CaseStatus'])

        # Adding unique constraint on 'CaseStatus', fields ['tenant', 'position']
        db.create_unique(u'cases_casestatus', ['tenant_id', 'position'])

        # Deleting field 'Case.status'
        db.delete_column(u'cases_case', 'status')

        # Adding field 'Case.status'
        db.add_column(u'cases_case', 'status',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='cases', null=True, to=orm['cases.CaseStatus']),
                      keep_default=False)


    def backwards(self, orm):
        # Removing unique constraint on 'CaseStatus', fields ['tenant', 'position']
        db.delete_unique(u'cases_casestatus', ['tenant_id', 'position'])

        # Deleting model 'CaseStatus'
        db.delete_table(u'cases_casestatus')

        # Deleting field 'Case.status'
        db.delete_column(u'cases_case', 'status_id')
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 13, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'cases.casestatus': {
            'Meta': {'unique_together': "(('tenant', 'position'),)", 'object_name': 'CaseStatus'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
