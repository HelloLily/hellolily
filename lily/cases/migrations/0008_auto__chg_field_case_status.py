...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'cases_case', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(default=-1, to=orm['cases.CaseStatus']))

    def backwards(self, orm):

        # Changing field 'Case.status'
        db.alter_column(u'cases_case', 'status_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['cases.CaseStatus']))
