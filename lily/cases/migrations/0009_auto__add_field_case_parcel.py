...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Case.parcel'
        db.add_column(u'cases_case', 'parcel',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['parcels.Parcel'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Case.parcel'
        db.delete_column(u'cases_case', 'parcel_id')
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 15, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'parcels.parcel': {
            ...
            'provider': ('django.db.models.fields.CharField', [], {'default': "'DPD'", 'max_length': '50'}),
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['tenant.Tenant']", 'blank': 'True'})
        },
        u'tenant.tenant': {
