...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'cases_case', 'assigned_to_id')

        # Renaming field 'Case.assigned_to2' to 'Case.assigned_to'
        db.rename_column(u'cases_case', 'assigned_to2_id', 'assigned_to_id')
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'cases_case', 'assigned_to', self.gf('django.db.models.fields.related.ForeignKey')(related_name='assigned_to', null=True, to=orm['users.CustomUser']), keep_default=False)
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.LilyUser']", 'null': 'True'}),
