...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseType.is_archived'
        db.add_column(u'cases_casetype', 'is_archived',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Case.created_by'
        db.add_column(u'cases_case', 'created_by',
                      self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='created_by', null=True, to=orm['users.LilyUser']),
                      keep_default=False)


        # Changing field 'Case.assigned_to'
        db.alter_column(u'cases_case', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.LilyUser']))

    def backwards(self, orm):
        # Deleting field 'CaseType.is_archived'
        db.delete_column(u'cases_casetype', 'is_archived')

        # Deleting field 'Case.created_by'
        db.delete_column(u'cases_case', 'created_by_id')


        # Changing field 'Case.assigned_to'
        db.alter_column(u'cases_case', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.LilyUser']))
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'assigned_to': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'assigned_to'", 'null': 'True', 'to': u"orm['users.LilyUser']"}),
            'contact': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['contacts.Contact']", 'null': 'True', 'blank': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'created_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'created_by'", 'null': 'True', 'to': u"orm['users.LilyUser']"}),
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 1, 28, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
