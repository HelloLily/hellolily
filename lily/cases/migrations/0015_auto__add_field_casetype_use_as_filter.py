...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CaseType.use_as_filter'
        db.add_column(u'cases_casetype', 'use_as_filter',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CaseType.use_as_filter'
        db.delete_column(u'cases_casetype', 'use_as_filter')
    ...
    models = {
        ...
        u'cases.case': {
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expires': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 2, 5, 0, 0)'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
