...
from lily.cases.views import CreateCaseView, DetailCaseView, UpdateCaseView, DeleteCaseView, ListCaseView, \
    delete_case_view, update_status_view, archive_cases_view, archived_cases_view, unarchive_cases_view
...
urlpatterns = patterns(
    ...
    url(r'^archive/$', archived_cases_view, name='case_archived_list'),
