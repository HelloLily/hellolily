...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Contact.tenant'
        db.alter_column('contacts_contact', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multitenant.Tenant']))
    def backwards(self, orm):

        # Changing field 'Contact.tenant'
        db.alter_column('contacts_contact', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multitenant.TenantModel']))
    models = {
        'accounts.account': {
