...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.closed_date'
        db.alter_column('deals_deal', 'closed_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    def backwards(self, orm):

        # Changing field 'Deal.closed_date'
        db.alter_column('deals_deal', 'closed_date', self.gf('django.db.models.fields.DateTimeField')(default=None))
    models = {
        'accounts.account': {
        ...
        'deals.deal': {
            ...
            'closed_date': ('django.db.models.fields.DateTimeField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
