...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.created'
        db.add_column('deals_deal', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Deal.modified'
        db.add_column('deals_deal', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Deal.deleted'
        db.add_column('deals_deal', 'deleted',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Deal.is_deleted'
        db.add_column('deals_deal', 'is_deleted',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Deal.created'
        db.delete_column('deals_deal', 'created')

        # Deleting field 'Deal.modified'
        db.delete_column('deals_deal', 'modified')

        # Deleting field 'Deal.deleted'
        db.delete_column('deals_deal', 'deleted')

        # Deleting field 'Deal.is_deleted'
        db.delete_column('deals_deal', 'is_deleted')
