...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'deals_deal', 'amount')

        # Adding field 'Deal.amount_once'
        db.add_column(u'deals_deal', 'amount_once',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Adding field 'Deal.amount_recurring'
        db.add_column(u'deals_deal', 'amount_recurring',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Changing field 'Deal.assigned_to'
        db.alter_column(u'deals_deal', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.LilyUser']))

    def backwards(self, orm):
        # Adding field 'Deal.amount'
        db.add_column(u'deals_deal', 'amount',
                      self.gf('django.db.models.fields.DecimalField')(default=0, max_digits=19, decimal_places=2),
                      keep_default=False)

        # Deleting field 'Deal.amount_once'
        db.delete_column(u'deals_deal', 'amount_once')

        # Deleting field 'Deal.amount_recurring'
        db.delete_column(u'deals_deal', 'amount_recurring')

        # Changing field 'Deal.assigned_to'
        db.alter_column(u'deals_deal', 'assigned_to_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.CustomUser']))
    ...
    models = {
        ...
        u'deals.deal': {
            ...
            'amount_recurring': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            'amount_once': ('django.db.models.fields.DecimalField', [], {'max_digits': '19', 'decimal_places': '2'}),
            ...
            'deleted': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'blank': 'True'}),
            'expected_closing_date': ('django.db.models.fields.DateField', [], {}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
