...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.feedback_form_sent'
        db.add_column(u'deals_deal', 'feedback_form_sent',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Deal.feedback_form_sent'
        db.delete_column(u'deals_deal', 'feedback_form_sent')
    ...
    models = {
        ...
        u'deals.deal': {
            ...
            'feedback_form_sent': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
