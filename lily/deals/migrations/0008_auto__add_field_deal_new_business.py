...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Deal.new_business'
        db.add_column(u'deals_deal', 'new_business',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'Deal.new_business'
        db.delete_column(u'deals_deal', 'new_business')
    ...
    models = {
        ...
        u'deals.deal': {
            ...
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'new_business': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
