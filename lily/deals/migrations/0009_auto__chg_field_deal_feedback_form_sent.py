...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Deal.feedback_form_sent'
        db.execute(
            'ALTER TABLE "deals_deal" '
            'ALTER COLUMN "feedback_form_sent" DROP DEFAULT, '
            'ALTER COLUMN "feedback_form_sent" DROP NOT NULL, '
            'ALTER COLUMN "feedback_form_sent" TYPE bool '
            'USING '
            'CASE '
            '  WHEN feedback_form_sent=0 THEN FALSE ELSE TRUE '
            'END'
        )
    ...
    def backwards(self, orm):
        ...
        db.execute(
            ...
            'ALTER COLUMN "feedback_form_sent" DROP DEFAULT, '
            'ALTER COLUMN "feedback_form_sent" DROP NOT NULL, '
            'ALTER COLUMN "feedback_form_sent" TYPE INTEGER '
            'USING '
            'CASE '
    ...
    models = {
        ...
        u'deals.deal': {
            ...
            'feedback_form_sent': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
