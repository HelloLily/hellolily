...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'google_flowmodel', (
            ('id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.LilyUser'], primary_key=True)),
    ...
    models = {
        ...
        u'google.flowmodel': {
            ...
            'id': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.LilyUser']", 'primary_key': 'True'})
        },
        u'tenant.tenant': {
