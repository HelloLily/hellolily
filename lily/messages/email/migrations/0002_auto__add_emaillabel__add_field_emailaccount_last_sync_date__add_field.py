...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailAccount.last_sync_date'
        db.add_column('email_emailaccount', 'last_sync_date',
                      self.gf('django.db.models.fields.DateField')(default=datetime.datetime(1970, 1, 1, 0, 0)),
                      keep_default=False)

        # Adding field 'EmailMessage.date'
        db.add_column('email_emailmessage', 'date',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'EmailAccount.last_sync_date'
        db.delete_column('email_emailaccount', 'last_sync_date')

        # Deleting field 'EmailMessage.date'
        db.delete_column('email_emailmessage', 'date')
