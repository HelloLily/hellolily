...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailAttachment.size'
        db.alter_column('email_emailattachment', 'size', self.gf('django.db.models.fields.PositiveIntegerField')())

    def backwards(self, orm):

        # Changing field 'EmailAttachment.size'
        db.alter_column('email_emailattachment', 'size', self.gf('django.db.models.fields.IntegerField')())
