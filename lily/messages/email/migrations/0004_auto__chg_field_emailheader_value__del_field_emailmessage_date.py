...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailHeader.value'
        db.alter_column('email_emailheader', 'value', self.gf('django.db.models.fields.TextField')())
    ...
    def backwards(self, orm):
        ...
        # Changing field 'EmailHeader.value'
        db.alter_column('email_emailheader', 'value', self.gf('django.db.models.fields.CharField')(max_length=255))
