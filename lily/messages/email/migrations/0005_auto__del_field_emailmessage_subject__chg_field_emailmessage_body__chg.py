...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmailMessage.subject'
        db.delete_column('email_emailmessage', 'subject')


        # Changing field 'EmailMessage.body'
        db.alter_column('email_emailmessage', 'body', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EmailMessage.flags'
        db.alter_column('email_emailmessage', 'flags', self.gf('django.db.models.fields.TextField')(null=True))

        # Changing field 'EmailMessage.size'
        db.alter_column('email_emailmessage', 'size', self.gf('django.db.models.fields.IntegerField')(null=True))

    def backwards(self, orm):
        # Adding field 'EmailMessage.subject'
        db.add_column('email_emailmessage', 'subject',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


        # Changing field 'EmailMessage.body'
        db.alter_column('email_emailmessage', 'body', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'EmailMessage.flags'
        db.alter_column('email_emailmessage', 'flags', self.gf('django.db.models.fields.TextField')(default=''))

        # Changing field 'EmailMessage.size'
        db.alter_column('email_emailmessage', 'size', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'email.emailaccount': {
            ...
            'last_sync_date': ('django.db.models.fields.DateField', [], {}),
