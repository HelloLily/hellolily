...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('email_emailheader', 'value', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'EmailHeader.value'
        db.alter_column('email_emailheader', 'value', self.gf('django.db.models.fields.TextField')(default=None))
