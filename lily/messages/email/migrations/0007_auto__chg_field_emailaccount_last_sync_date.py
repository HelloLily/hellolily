...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('email_emailaccount', 'last_sync_date', self.gf('django.db.models.fields.DateTimeField')())

    def backwards(self, orm):

        # Changing field 'EmailAccount.last_sync_date'
        db.alter_column('email_emailaccount', 'last_sync_date', self.gf('django.db.models.fields.DateField')())
