...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'EmailMessage.private'
        db.delete_column('email_emailmessage', 'private')

        # Adding field 'EmailMessage.is_private'
        db.add_column('email_emailmessage', 'is_private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'EmailMessage.private'
        db.add_column('email_emailmessage', 'private',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Deleting field 'EmailMessage.is_private'
        db.delete_column('email_emailmessage', 'is_private')
