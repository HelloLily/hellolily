...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailMessage.folder_name'
        db.add_column('email_emailmessage', 'folder_name',
                      self.gf('django.db.models.fields.CharField')(default='\\AllMail', max_length=255),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailMessage.folder_name'
        db.delete_column('email_emailmessage', 'folder_name')
