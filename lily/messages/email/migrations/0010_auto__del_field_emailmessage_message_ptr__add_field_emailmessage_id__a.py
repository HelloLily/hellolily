...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'EmailMessage.id'
        db.add_column('email_emailmessage', 'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=True)

        # Adding field 'EmailMessage.tenant'
        db.add_column('email_emailmessage', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tenant.Tenant'], blank=True),
                      keep_default=False)

        # Adding field 'EmailMessage.created'
        db.add_column('email_emailmessage', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'EmailMessage.modified'
        db.add_column('email_emailmessage', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'EmailMessage.polymorphic_ctype'
        db.add_column('email_emailmessage', 'polymorphic_ctype',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_email.emailmessage_set', null=True, to=orm['contenttypes.ContentType']),
                      keep_default=False)

        # Adding field 'EmailMessage.sent_date'
        db.add_column('email_emailmessage', 'sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True),
                      keep_default=False)

        # Adding field 'EmailMessage.is_seen'
        db.add_column('email_emailmessage', 'is_seen',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EmailMessage.account'
        db.add_column('email_emailmessage', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='messages', to=orm['messages.MessagesAccount']),
                      keep_default=False)

        # Adding unique constraint on 'EmailMessage', fields ['account', 'uid', 'folder_name']
        db.create_unique('email_emailmessage', ['account_id', 'uid', 'folder_name'])


    def backwards(self, orm):
        # Removing unique constraint on 'EmailMessage', fields ['account', 'uid', 'folder_name']
        db.delete_unique('email_emailmessage', ['account_id', 'uid', 'folder_name'])

        # Adding field 'EmailMessage.message_ptr'
        db.add_column('email_emailmessage', 'message_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['messages.Message'], unique=True, primary_key=True),
                      keep_default=False)

        # Deleting field 'EmailMessage.id'
        db.delete_column('email_emailmessage', 'id')

        # Deleting field 'EmailMessage.tenant'
        db.delete_column('email_emailmessage', 'tenant_id')

        # Deleting field 'EmailMessage.created'
        db.delete_column('email_emailmessage', 'created')

        # Deleting field 'EmailMessage.modified'
        db.delete_column('email_emailmessage', 'modified')

        # Deleting field 'EmailMessage.polymorphic_ctype'
        db.delete_column('email_emailmessage', 'polymorphic_ctype_id')

        # Deleting field 'EmailMessage.sent_date'
        db.delete_column('email_emailmessage', 'sent_date')

        # Deleting field 'EmailMessage.is_seen'
        db.delete_column('email_emailmessage', 'is_seen')

        # Deleting field 'EmailMessage.account'
        db.delete_column('email_emailmessage', 'account_id')
    ...
    models = {
        ...
        'email.emailaccount': {
            'Meta': {'object_name': 'EmailAccount', '_ormbases': ['messages.MessagesAccount']},
            ...
            'messagesaccount_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['messages.MessagesAccount']", 'unique': 'True', 'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
        ...
        'email.emailmessage': {
            ...
            'account': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'messages'", 'to': "orm['messages.MessagesAccount']"}),
        ...
        'email.emailprovider': {
            ...
            'retrieve_host': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'retrieve_port': ('django.db.models.fields.IntegerField', [], {}),
            'send_host': ('django.db.models.fields.CharField', [], {'max_length': '32'}),
            'send_port': ('django.db.models.fields.IntegerField', [], {}),
            'send_use_tls': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tenant.Tenant']", 'blank': 'True'})
        },
        'email.emailtemplate': {
        ...
        'email.emailtemplateparameters': {
            'Meta': {'object_name': 'EmailTemplateParameters'},
            'default_value': ('django.db.models.fields.CharField', [], {'max_length': '255', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '255'}),
            'template': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'parameters'", 'to': "orm['email.EmailTemplate']"}),
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tenant.Tenant']", 'blank': 'True'})
        },
        'messages.messagesaccount': {
