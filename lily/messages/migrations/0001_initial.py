...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('messages_messagesaccount', (
        ...
        db.send_create_signal('messages', ['MessagesAccount'])

        # Adding M2M table for field user_group on 'MessagesAccount'
        db.create_table('messages_messagesaccount_user_group', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('messagesaccount', models.ForeignKey(orm['messages.messagesaccount'], null=False)),
            ('customuser', models.ForeignKey(orm['users.customuser'], null=False))
        ))
        db.create_unique('messages_messagesaccount_user_group', ['messagesaccount_id', 'customuser_id'])
        ...
        db.create_table('messages_message', (
            ...
            ('account', self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages', to=orm['messages.MessagesAccount'])),
        ))
    ...
    def backwards(self, orm):
        ...
        db.delete_table('messages_messagesaccount')

        # Removing M2M table for field user_group on 'MessagesAccount'
        db.delete_table('messages_messagesaccount_user_group')
