...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('messages_message', 'datetime')

        # Adding field 'Message.sent_date'
        db.add_column('messages_message', 'sent_date',
