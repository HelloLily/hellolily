...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailAttachment.attachment'
        db.alter_column('email_emailattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EmailAttachment.attachment'
        db.alter_column('email_emailattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
