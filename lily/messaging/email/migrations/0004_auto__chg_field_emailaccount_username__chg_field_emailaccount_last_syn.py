...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('email_emailaccount', 'last_sync_date', self.gf('django.db.models.fields.DateTimeField')(null=True))
    ...
    models = {
        ...
        'email.emailaccount': {
            ...
            'password': ('django_fields.fields.EncryptedCharField', [], {'max_length': '549', 'block_type': 'None', 'cipher': "'AES'"}),
            ...
            'username': ('django_fields.fields.EncryptedCharField', [], {'max_length': '549', 'block_type': 'None', 'cipher': "'AES'"})
        },
