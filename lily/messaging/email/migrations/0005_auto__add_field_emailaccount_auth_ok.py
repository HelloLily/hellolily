...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAccount.auth_ok'
        db.add_column('email_emailaccount', 'auth_ok',
                      self.gf('django.db.models.fields.IntegerField')(default=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAccount.auth_ok'
        db.delete_column('email_emailaccount', 'auth_ok')
