...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailAccount.username'
        db.alter_column('email_emailaccount', 'username', self.gf('django_fields.fields.EncryptedCharField')(max_length=558, block_type='MODE_CBC', cipher='AES'))

        # Changing field 'EmailAccount.password'
        db.alter_column('email_emailaccount', 'password', self.gf('django_fields.fields.EncryptedCharField')(max_length=558, block_type='MODE_CBC', cipher='AES'))
        # Deleting field 'EmailTemplate.body_text'
        db.delete_column('email_emailtemplate', 'body_text')

        # Deleting field 'EmailDraft.body_text'
        db.delete_column('email_emaildraft', 'body_text')


    def backwards(self, orm):

        # Changing field 'EmailAccount.username'
        db.alter_column('email_emailaccount', 'username', self.gf('django_fields.fields.EncryptedCharField')(max_length=549, block_type=None, cipher='AES'))

        # Changing field 'EmailAccount.password'
        db.alter_column('email_emailaccount', 'password', self.gf('django_fields.fields.EncryptedCharField')(max_length=549, block_type=None, cipher='AES'))
        # Adding field 'EmailTemplate.body_text'
        db.add_column('email_emailtemplate', 'body_text',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EmailDraft.body_text'
        db.add_column('email_emaildraft', 'body_text',
