...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        # Removing index on 'EmailHeader', fields ['name']
        db.delete_index(u'email_emailheader', ['name'])

        # Deleting model 'EmailAddressHeader'
        db.delete_table(u'email_emailaddressheader')

        # Removing index on 'EmailMessage', fields ['folder_identifier']
        db.delete_index(u'email_emailmessage', ['folder_identifier'])
