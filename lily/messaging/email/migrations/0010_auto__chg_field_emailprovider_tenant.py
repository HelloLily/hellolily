...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailProvider.tenant'
        db.alter_column(u'email_emailprovider', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tenant.Tenant'], null=True))

    def backwards(self, orm):

        # Changing field 'EmailProvider.tenant'
        db.alter_column(u'email_emailprovider', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tenant.Tenant']))
