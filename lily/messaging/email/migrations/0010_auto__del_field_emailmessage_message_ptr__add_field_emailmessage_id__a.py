...
class Migration(SchemaMigration):
    ...
    needed_by = (
        ('messaging', '0004_auto__del_message'),
    )
    ...
    def forwards(self, orm):
        ...
        db.add_column('email_emailmessage', 'account',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='messages', to=orm['messaging.MessagesAccount']),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column('email_emailmessage', 'message_ptr',
                      self.gf('django.db.models.fields.related.OneToOneField')(default=1, to=orm['messaging.Message'], unique=True, primary_key=True),
                      keep_default=False)
