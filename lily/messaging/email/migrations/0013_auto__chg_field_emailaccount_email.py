...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Delete field 'EmailAccount.email'
        db.delete_column('email_emailaccount', 'email')

        # Add column for 'EmailAccount.email_id'.
        db.add_column('email_emailaccount', 'email', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['utils.EmailAddress'], default=1))

        # Adding index on 'EmailAccount', fields ['email']
        db.create_index('email_emailaccount', ['email'])

    def backwards(self, orm):
        # Removing index on 'EmailAccount', fields ['email']
        db.delete_index('email_emailaccount', ['email_id'])

        # Delete column
        db.delete_column('email_emailaccount', 'email_id')

        # Add column for 'EmailAccount.email'.
        db.add_column('email_emailaccount', 'email', self.gf('django_fields.fields.EncryptedEmailField')(max_length=549, cipher='AES'))
    ...
    models = {
        ...
        'email.emailaccount': {
            ...
            'email': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'email'", 'to': "orm['utils.EmailAddress']"}),
