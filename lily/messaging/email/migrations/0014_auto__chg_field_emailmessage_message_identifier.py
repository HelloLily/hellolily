...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'EmailMessage.message_identifier'
        db.alter_column(u'email_emailmessage', 'message_identifier', self.gf('django.db.models.fields.CharField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'EmailMessage.message_identifier'
        db.alter_column(u'email_emailmessage', 'message_identifier', self.gf('django.db.models.fields.TextField')())
