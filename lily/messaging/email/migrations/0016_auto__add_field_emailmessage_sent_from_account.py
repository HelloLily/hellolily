...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailMessage.sent_from_account'
        db.add_column(u'email_emailmessage', 'sent_from_account',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailMessage.sent_from_account'
        db.delete_column(u'email_emailmessage', 'sent_from_account')
