...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailMessage.folder_identifier'
        db.add_column('email_emailmessage', 'folder_identifier',
                      self.gf('django.db.models.fields.CharField')(max_length=255, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailMessage.folder_identifier'
        db.delete_column('email_emailmessage', 'folder_identifier')
