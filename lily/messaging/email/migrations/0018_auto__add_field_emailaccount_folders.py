...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAccount.folders'
        db.add_column('email_emailaccount', 'folders',
                      self.gf('django.db.models.fields.TextField')(default='{}'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAccount.folders'
        db.delete_column('email_emailaccount', 'folders')
