...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Renaming field 'EmailMessage.body'
        db.rename_column('email_emailmessage', 'body', 'body_html')

    def backwards(self, orm):
        # Renaming field 'EmailMessage.body_html'
        db.rename_column('email_emailmessage', 'body_html', 'body')
