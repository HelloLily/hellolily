...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailAttachment.inline'
        db.add_column('email_emailattachment', 'inline',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'EmailAttachment.inline'
        db.delete_column('email_emailattachment', 'inline')
