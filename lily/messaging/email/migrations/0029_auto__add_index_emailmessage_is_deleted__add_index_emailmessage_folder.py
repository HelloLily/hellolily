...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding index on 'EmailMessage', fields ['is_deleted']
        db.create_index(u'email_emailmessage', ['is_deleted'])

        # Adding index on 'EmailMessage', fields ['folder_name']
        db.create_index(u'email_emailmessage', ['folder_name'])


    def backwards(self, orm):
        # Removing index on 'EmailMessage', fields ['folder_name']
        db.delete_index(u'email_emailmessage', ['folder_name'])

        # Removing index on 'EmailMessage', fields ['is_deleted']
        db.delete_index(u'email_emailmessage', ['is_deleted'])
