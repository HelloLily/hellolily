...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'EmailTemplateAttachment.tenant'
        db.add_column(u'email_emailtemplateattachment', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['tenant.Tenant'], blank=True),
                      keep_default=False)

        # Adding field 'EmailTemplateAttachment.size'
        db.add_column(u'email_emailtemplateattachment', 'size',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'EmailTemplateAttachment.content_type'
        db.add_column(u'email_emailtemplateattachment', 'content_type',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=255),
                      keep_default=False)

        # Changing field 'EmailTemplateAttachment.attachment'
        db.alter_column(u'email_emailtemplateattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=255))

    def backwards(self, orm):
        # Deleting field 'EmailTemplateAttachment.tenant'
        db.delete_column(u'email_emailtemplateattachment', 'tenant_id')

        # Deleting field 'EmailTemplateAttachment.size'
        db.delete_column(u'email_emailtemplateattachment', 'size')

        # Deleting field 'EmailTemplateAttachment.content_type'
        db.delete_column(u'email_emailtemplateattachment', 'content_type')


        # Changing field 'EmailTemplateAttachment.attachment'
        db.alter_column(u'email_emailtemplateattachment', 'attachment', self.gf('django.db.models.fields.files.FileField')(max_length=100))
    ...
    models = {
        ...
        'email.emailmessage': {
            ...
            'folder_name': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_index': 'True'}),
