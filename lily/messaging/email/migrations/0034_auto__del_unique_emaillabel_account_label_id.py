...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Removing unique constraint on 'EmailLabel', fields ['account', 'label_id']
        db.delete_unique(u'email_emaillabel', ['account_id', 'label_id'])


    def backwards(self, orm):
        # Adding unique constraint on 'EmailLabel', fields ['account', 'label_id']
        db.create_unique(u'email_emaillabel', ['account_id', 'label_id'])
