...
class EmailMessage(models.Model):
    ...
    def message_type(self):
        ...
        if email:
            # TODO: following lines are heavy db operations, verify if qs union is usefull here.
            # https://docs.djangoproject.com/en/1.11/ref/models/querysets/#django.db.models.query.QuerySet.union
            # receivers = email.received_by.all() | email.received_by_cc.all()
            # numbers_of_receivers = receivers.distinct().count()
