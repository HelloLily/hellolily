...
urlpatterns = [
    ...
    url(r'^templates/get-default/$',
        EmailTemplateGetDefaultView.as_view(),
        name='messaging_email_template_get_default'),
    url(r'^templates/detail/(?P<template_id>[\d-]+)/$',
    ...
    url(r'^compose/(?P<email_address>[^/]+)/(?P<template>[\d-]+)/$',
