...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column('messaging_message', 'datetime')

        # Adding field 'Message.sent_date'
        db.add_column('messaging_message', 'sent_date',
