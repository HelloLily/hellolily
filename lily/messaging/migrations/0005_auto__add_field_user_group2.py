...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field user_group2 on 'MessagesAccount'
        m2m_table_name = db.shorten_name(u'messaging_messagesaccount_user_group2')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('messagesaccount', models.ForeignKey(orm[u'messaging.messagesaccount'], null=False)),
            ('lilyuser', models.ForeignKey(orm[u'users.lilyuser'], null=False))
        ))
        db.create_unique(m2m_table_name, ['messagesaccount_id', 'lilyuser_id'])


    def backwards(self, orm):
        # Removing M2M table for field user_group2 on 'MessagesAccount'
        db.delete_table(db.shorten_name(u'messaging_messagesaccount_user_group2'))
