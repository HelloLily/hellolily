...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        try:
            old_messages_account_ctype = ContentType.objects.get(app_label='messages', model='MessagesAccount'.lower())
        except ContentType.DoesNotExist:
            pass
        else:
            new_messages_account_ctype = ContentType.objects.get_for_model(MessagesAccount)
            MessagesAccount.objects.filter(polymorphic_ctype=old_messages_account_ctype).update(polymorphic_ctype=new_messages_account_ctype)
    ...
    def backwards(self, orm):
        ...
        from lily.messages.models import MessagesAccount
        try:
            old_messages_account_ctype = ContentType.objects.get(app_label='messaging', model='MessagesAccount'.lower())
        except ContentType.DoesNotExist:
            pass
        else:
            new_messages_account_ctype = ContentType.objects.get_for_model(MessagesAccount)
