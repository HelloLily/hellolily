...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # Remove user_group table
        db.delete_table('messaging_messagesaccount_user_group')

        # Rename user_group2 to user_group
        db.rename_table('messaging_messagesaccount_user_group2', 'messaging_messagesaccount_user_group')

        db.delete_primary_key('messaging_messagesaccount_user_group')
        db.create_primary_key('messaging_messagesaccount_user_group', ['id'])

    def backwards(self, orm):
        # Rename user_group to user_group2
        db.rename_table('messaging_messagesaccount_user_group', 'messaging_messagesaccount_user_group2')
        ...
        db.delete_primary_key('messaging_messagesaccount_user_group2')
        db.create_primary_key('messaging_messagesaccount_user_group2', ['id'])
