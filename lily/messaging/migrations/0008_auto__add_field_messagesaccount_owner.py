...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'MessagesAccount.owner'
        db.add_column(u'messaging_messagesaccount', 'owner',
                      self.gf('django.db.models.fields.related.ForeignKey')(related_name='messages_accounts_owned', null=True, to=orm['users.LilyUser']),
                      keep_default=False)

    def backwards(self, orm):
        # Deleting field 'MessagesAccount.owner'
        db.delete_column(u'messaging_messagesaccount', 'owner_id')
