...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Changing field 'MessagesAccount.owner' with bogus default value, since the previous datamigration filled it
        db.alter_column(u'messaging_messagesaccount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.LilyUser']))

    def backwards(self, orm):
        # Changing field 'MessagesAccount.owner'
        db.alter_column(u'messaging_messagesaccount', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['users.LilyUser']))
