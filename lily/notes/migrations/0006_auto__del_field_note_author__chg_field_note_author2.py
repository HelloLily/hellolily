...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Renaming field 'Note.author2' to 'Note.author'
        db.rename_column(u'notes_note', 'author2_id', 'author_id')

        # Changing field 'Note.author'
        db.alter_column(u'notes_note', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['users.LilyUser']))

    def backwards(self, orm):
        # Renaming field 'Case.assigned_to2' to 'Case.assigned_to'
        db.rename_column(u'notes_note', 'author_id', 'author2_id')

        # Changing field 'Case.assigned_to'
        db.alter_column(u'notes_note', 'author2_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['users.LilyUser'], null=True))

        # Adding field 'Case.assigned_to'
        db.add_column(u'notes_note', 'author_id', self.gf('django.db.models.fields.related.ForeignKey')(related_name='author', null=True, to=orm['users.CustomUser']), keep_default=False)
    ...
    models = {
        ...
        u'notes.note': {
            ...
            'author': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['users.LilyUser']"}),
