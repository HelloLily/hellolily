...
DATAPROVIDER_API_LOOKUP_URL = 'https://www.dataprovider.com/api/3.0/lookup/hostname.json'
DATAPROVIDER_API_ENRICH_URL = 'https://www.dataprovider.com/api/3.0/enrich/enrich.json'
