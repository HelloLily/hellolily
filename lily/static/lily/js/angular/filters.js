 ...
 */
var LilyFilters = angular.module('LilyFilters', []);
 ...
 */
LilyFilters.filter('relativeDate', ['$filter', function($filter) {
...
LilyFilters.filter('minValue', function() {
...
LilyFilters.filter('nl2br', ['$sce', function($sce) {
...
LilyFilters.filter('trustAsResourceUrl', ['$sce', function($sce) {
    return function(val) {
