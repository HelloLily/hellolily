...
Customized to fix toolbar buttons layout.
*/
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.hallo", {
      ...
      _setToolbarPosition: function() {
        ...
        this.toolbar.css('top', this.element.offset().top);
      ...
      _create: function() {
        ...
        buttonize = function(type, label) {
          ...
          buttonElement.hallobutton({
            ...
            icon: type === 'Ordered' ? 'icon-list-ol' : 'icon-list-ul',
            cssClass: _this.options.buttonCssClass
          });
          return buttonset.append(buttonElement);
        };
        if (this.options.lists.ordered) {
          buttonize("Ordered", "Numbered list");
        }
        if (this.options.lists.unordered) {
          buttonize("Unordered", "Bullet list");
        }
        buttonset.buttonset();
  ...
  (function(jQuery) {
    return jQuery.widget("IKS.hallolink", {
      ...
      _create: function() {
        ...
        dialog = jQuery("<div id=\"" + dialogId + "\"><form action=\"#\" method=\"post\" class=\"mws-form linkForm\"><label for=\"hallo-link\">Url</label<input class=\"url mws-textinput\" type=\"text\" id=\"hallo-link\" name=\"url\" value=\"" + this.options.defaultUrl + "\" /><input type=\"submit\" id=\"addlinkButton mws-button blue\" value=\"Insert\" /></form></div>");
        ...
        buttonize = function(type) {
          ...
          buttonset.append(jQuery("<input id=\"" + id + "\" type=\"checkbox\" /><label for=\"" + id + "\" class=\"anchor_button\" title=\"Insert link\"><i class=\"icon-link\"></i></label>").button());
          button = jQuery("#" + id, buttonset);
          button.bind("change", function(event) {
    ...
    return jQuery.widget('Hallo.halloToolbarFixed', {
      ...
      _updatePosition: function(position) {
        if(this.options.positionAbove) {
          var left, toolbar_height_offset, top, top_offset;
          if (!position) {
            return;
          }
          if (!(position.top && position.left)) {
