...
var App = function () {
    ...
    var handleUniform = function () {
        ...
        if (test.size() > 0) {
            test.each(function () {
                if ($(this).parents(".checker").size() === 0 && !$(this).is('[data-skip-uniform]')) {
                    $(this).show();
                    $(this).uniform();
                }
            });
    ...
    return {
        ...
        blockUI: function (el, centerY, message) {
            el = jQuery(el);
            if (el.height() <= 400) {
                centerY = true;
            }
            el.block({
                ...
                message: message !== undefined ? message : '<img src="./assets/img/ajax-loading.gif" align="">',
