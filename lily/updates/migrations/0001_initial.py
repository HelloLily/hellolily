...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('updates_blogentry', (
            ...
            ('reply_to', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['updates.BlogEntry'], null=True, blank=True)),
        ))
        db.send_create_signal('updates', ['BlogEntry'])


    def backwards(self, orm):
        # Deleting model 'BlogEntry'
        db.delete_table('updates_blogentry')
    ...
    models = {
        ...
        'updates.blogentry': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'modified': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'reply_to': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['updates.BlogEntry']", 'null': 'True', 'blank': 'True'}),
            'tenant': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['tenant.Tenant']", 'blank': 'True'})
        },
        'users.customuser': {
