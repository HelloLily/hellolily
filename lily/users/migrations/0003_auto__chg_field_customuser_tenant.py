...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CustomUser.tenant'
        db.alter_column('users_customuser', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['tenant.Tenant']))
    def backwards(self, orm):

        # Changing field 'CustomUser.tenant'
        db.alter_column('users_customuser', 'tenant_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['multitenant.Tenant']))
    models = {
        'accounts.account': {
