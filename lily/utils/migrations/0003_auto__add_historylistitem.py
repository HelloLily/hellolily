...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'HistoryListItem'
        db.create_table('utils_historylistitem', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('polymorphic_ctype', self.gf('django.db.models.fields.related.ForeignKey')(related_name='polymorphic_utils.historylistitem_set', null=True, to=orm['contenttypes.ContentType'])),
        ))
        db.send_create_signal('utils', ['HistoryListItem'])


    def backwards(self, orm):
        # Deleting model 'HistoryListItem'
        db.delete_table('utils_historylistitem')
