...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('utils_historylistitem', 'sort_by_date',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2013, 8, 26, 0, 0)),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoryListItem.sort_by_date'
        db.delete_column('utils_historylistitem', 'sort_by_date')
