...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('utils_socialmedia', 'profile_url', self.gf('django.db.models.fields.URLField')(max_length=255))

    def backwards(self, orm):

        # Changing field 'SocialMedia.profile_url'
        db.alter_column('utils_socialmedia', 'profile_url', self.gf('django.db.models.fields.URLField')(max_length=200))
