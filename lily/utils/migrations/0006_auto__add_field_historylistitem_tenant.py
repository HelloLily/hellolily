...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'HistoryListItem.tenant'
        db.add_column('utils_historylistitem', 'tenant',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['tenant.Tenant'], blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'HistoryListItem.tenant'
        db.delete_column('utils_historylistitem', 'tenant_id')
