...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SocialMedia.profile_url'
        db.alter_column(u'utils_socialmedia', 'profile_url', self.gf('django.db.models.fields.URLField')(max_length=255, null=True))

    def backwards(self, orm):

        # Changing field 'SocialMedia.profile_url'
        db.alter_column(u'utils_socialmedia', 'profile_url', self.gf('django.db.models.fields.URLField')(default=None, max_length=255))
