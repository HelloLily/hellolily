...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        email_addresses = orm.EmailAddress.objects.all()
        total_email_addresses = email_addresses.count()

        i = 0
        for email_address in email_addresses:
            email_address.email_address = email_address.email_address.lower()
            email_address.save()

            if settings.SOUTH_VERBOSITY > 0:
                i += 1
                print_progress(i, total_email_addresses)
