(function () {
    ...
    angular.module('UtilsDirectives').directive('historyList', HistoryList);
    ...
    function HistoryList($filter, $http, $modal, $q, $state, EmailAccount, NoteDetail, CaseDetail, DealDetail, EmailDetail) {
        return {
            restrict: 'E',
            replace: true,
            scope: {
            ...
            templateUrl: 'utils/history-list.html',
    ...
    angular.module('UtilsDirectives').directive('historyListItem', HistoryListItem);

    HistoryListItem.$inject = ['$compile', '$http', '$templateCache'];
    function HistoryListItem($compile, $http, $templateCache) {
        return {
            restrict: 'E',
            scope: {
                item:'=',
    ...
    angular.module('UtilsDirectives').directive('historyAddNote', historyAddNote);

    function historyAddNote () {
        return {
            restrict: 'E',
            scope: {
                item: '='
            },
            templateUrl: 'utils/history_add_note.html',
