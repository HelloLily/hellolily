...
from rest_framework.test import APISimpleTestCase, APIClient, APITestCase
...
class CallNotificationsV2APITestCase(APITestCase):
    list_url = 'callnotification-list'
    detail_url = 'callnotification-detail'
    ...
    def setUpTestData(cls):
        ...
        Creates a user and logs it in before running the actual tests.
        """
        super(CallNotificationsV2APITestCase, cls).setUpTestData()
    ...
    @classmethod
    def tearDownClass(cls):
        super(CallNotificationsV2APITestCase, cls).tearDownClass()
        set_current_user(None)
